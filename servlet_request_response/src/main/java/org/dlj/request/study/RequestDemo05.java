...
//		System.out.println("userName: " + userName);
		...
		System.out.println("post before setCharacterEncoding utf-8 userName: " + userName2);
		request.setCharacterEncoding("GB18030");
		String userName3 = request.getParameter("userName");
		System.out.println("post after  setcharacterEncoding GB18030 userName: " + userName3);
		request.setCharacterEncoding("ISO8859-1");
		String userName4 = request.getParameter("userName");
		System.out.println("post after  setcharacterEncoding ISO8859-1 userName: " + userName4);
		...
		String userName = request.getParameter("userName");
		System.out.println("post after  setcharacterEncoding utf-8 userName: " + userName);
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("post after  setcharacterEncoding GB18030 userName: " + userName3);
		System.out.println("post after  setcharacterEncoding GB18030 userName: " + new String(userName3.getBytes("GB18030"), "UTF-8"));
